...
/**
 * 阿里云百炼（BaiLian）Chat 客户端
 * <p>
 * 百炼平台兼容 OpenAI 协议，本客户端继承 {@link AbstractOpenAIStyleChatClient}
 * 复用其通用逻辑，仅需声明 provider 标识为 {@link ModelProvider#BAI_LIAN}
 *
...
public class BaiLianChatClient extends AbstractOpenAIStyleChatClient {
    ...
    /**
     * 同步聊天调用，通过 {@link RagTraceNode} 生成 "bailian-chat" trace 节点
     */
    @Override
