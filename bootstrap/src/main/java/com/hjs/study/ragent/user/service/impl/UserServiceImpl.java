...
package com.hjs.study.ragent.user.service.impl;
...
import com.hjs.study.ragent.user.controller.request.ChangePasswordRequest;
import com.hjs.study.ragent.user.controller.request.UserCreateRequest;
import com.hjs.study.ragent.user.controller.request.UserPageRequest;
import com.hjs.study.ragent.user.controller.request.UserUpdateRequest;
import com.hjs.study.ragent.user.controller.vo.UserVO;
import com.hjs.study.ragent.user.dao.entity.UserDO;
import com.hjs.study.ragent.user.dao.mapper.UserMapper;
import com.hjs.study.ragent.user.enums.UserRole;
import com.hjs.study.ragent.user.service.UserService;
...
public class UserServiceImpl implements UserService {
    ...
    @LogRecord(
            ...
            type = BizChangeBizType.USER,
            subType = BizChangeOperationType.UPDATE,
            bizNo = "{{T(com.hjs.study.ragent.framework.context.UserContext).getUserId()}}",
            extra = BizChangeLogContext.SNAPSHOT_EXPRESSION,
            condition = BizChangeLogContext.RECORD_CONDITION
    )
